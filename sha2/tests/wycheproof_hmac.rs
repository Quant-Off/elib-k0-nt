...
fn hmac<H: SHA2>(block: usize, key: &[u8], msg: &[u8]) -> Vec<u8> {
...
fn run_hmac<H: SHA2>(name: &str, block: usize) {
...
#[test]
fn wycheproof_hmac_sha2() {
    run_hmac::<SHA224>("HMAC_SHA224", 64);
    run_hmac::<SHA256>("HMAC_SHA256", 64);
    run_hmac::<SHA384>("HMAC_SHA384", 128);
    run_hmac::<SHA512>("HMAC_SHA512", 128);
}
